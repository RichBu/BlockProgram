 ...
 *
 * This file is copied from the vscode-debugprotocol npm package. It
 * is identical except that it declares a namespace rather than exporting
 * a declared module (necessary because our code uses namespaces and not
 * modules).
 */
declare namespace DebugProtocol {
    ...
    */
    ...
    type CompletionItemType = 'method' | 'function' | 'constructor' | 'field' | 'variable' | 'class' | 'export interface' | 'module' | 'property' | 'unit' | 'value' | 'enum' | 'keyword' | 'snippet' | 'text' | 'color' | 'file' | 'reference' | 'customcolor';
    /** Names of checksum algorithms that may be supported by a debug adapter. */
    type ChecksumAlgorithm = 'MD5' | 'SHA1' | 'SHA256' | 'SHA1Normalized' | 'SHA256Normalized' | 'timestamp';
