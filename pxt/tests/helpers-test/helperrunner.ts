...
const casesDir = path.join(process.cwd(), "tests", "helpers-test", "pytests");
const bareDir = path.relative(process.cwd(), path.join("tests", "helpers-test", "bare"));
...
class CompileHost extends TestHost {
    ...
    constructor(public filename: string) {
        super("helpers-test", { [pxt.MAIN_TS]: "" }, [], true);
